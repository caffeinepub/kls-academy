...
export class Backend implements backendInterface {
    ...
    async addCertificate(arg0: string, arg1: string, arg2: string, arg3: string, arg4: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCertificate(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async addNotice(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addResult(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addStudentCredential(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addStudentCredential(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async checkResult(arg0: string): Promise<[bigint, string]> {
        if (this.processError) {
            try {
                const result = await this.actor.checkResult(arg0);
                return [
                    result[0],
                    result[1]
                ];
    ...
    async verifyCertificate(arg0: string): Promise<[boolean, string]> {
        if (this.processError) {
            try {
